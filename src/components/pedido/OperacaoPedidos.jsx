...
import { buscarPedido, listarCozinha } from "../../services/pedidoService";
    ...
    return Promise.all(
        pedidos.map(async (pedido) => {
            ...
            try {
                ...
                return {
                    ...pedido,
                    numero: response.data?.numero ?? pedido.numero,
                    numeroPedido: response.data?.numeroPedido ?? pedido.numeroPedido,
                    numeroComercial: response.data?.numeroComercial ?? pedido.numeroComercial
                };
            } catch {
                return pedido;
            }
